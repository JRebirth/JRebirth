...
/**
 * The class <strong>DefaultTouchAdapter</strong>.
 *
...
public class DefaultTouchAdapter<C extends AbstractBaseController<?, ?>> extends AbstractDefaultAdapter<C> implements TouchAdapter {
     ...
     */
    @Override
    public void touch(final TouchEvent touchEvent) {
     ...
     */
    @Override
    public void touchMoved(final TouchEvent touchEvent) {
        // Nothing to do yet must be overridden
    }
     ...
     */
    @Override
    public void touchPressed(final TouchEvent touchEvent) {
        // Nothing to do yet must be overridden
    }
     ...
     */
    @Override
    public void touchReleased(final TouchEvent touchEvent) {
        // Nothing to do yet must be overridden
    }
     ...
     */
    @Override
    public void touchStationary(final TouchEvent touchEvent) {
        // Nothing to do yet must be overridden
    }
