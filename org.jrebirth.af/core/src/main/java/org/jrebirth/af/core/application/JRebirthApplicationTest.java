...
/**
 * Base class for JUnit 4 + TestFX tests that drive a {@link DefaultApplication}.
 * Kept in main sources (optional JUnit/TestFX deps) so showcase and other modules can extend it.
 *
