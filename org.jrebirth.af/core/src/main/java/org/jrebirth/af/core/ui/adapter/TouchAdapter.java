...
public interface TouchAdapter extends EventAdapter {
    ...
    default void touch(final TouchEvent touchEvent) {
        throw new CoreRuntimeException(NOT_IMPLEMENTED_YET, getClass(), "void touch(final TouchEvent touchEvent)");
    }
    ...
    default void touchMoved(final TouchEvent touchEvent) {
        throw new CoreRuntimeException(NOT_IMPLEMENTED_YET, getClass(), "void touchMoved(final TouchEvent touchEvent)");
    }
    ...
    default void touchPressed(final TouchEvent touchEvent) {
        throw new CoreRuntimeException(NOT_IMPLEMENTED_YET, getClass(), "void touchPressed(final TouchEvent touchEvent)");
    }
    ...
    default void touchReleased(final TouchEvent touchEvent) {
        throw new CoreRuntimeException(NOT_IMPLEMENTED_YET, getClass(), "void touchReleased(final TouchEvent touchEvent)");
    }
    ...
    default void touchStationary(final TouchEvent touchEvent) {
        throw new CoreRuntimeException(NOT_IMPLEMENTED_YET, getClass(), "void touchStationary(final TouchEvent touchEvent)");
    }
