...
public interface SwipeAdapter extends EventAdapter {
    ...
    default void anySwipe(final SwipeEvent swipeEvent) {
        throw new CoreRuntimeException(NOT_IMPLEMENTED_YET, getClass(), "void anySwipe(final SwipeEvent swipeEvent)");
    }
    ...
    default void swipeDown(final SwipeEvent swipeEvent) {
        throw new CoreRuntimeException(NOT_IMPLEMENTED_YET, getClass(), "void swipeDown(final SwipeEvent swipeEvent)");
    }
    ...
    default void swipeLeft(final SwipeEvent swipeEvent) {
        throw new CoreRuntimeException(NOT_IMPLEMENTED_YET, getClass(), "void swipeLeft(final SwipeEvent swipeEvent)");
    }
    ...
    default void swipeRight(final SwipeEvent swipeEvent) {
        throw new CoreRuntimeException(NOT_IMPLEMENTED_YET, getClass(), "void swipeRight(final SwipeEvent swipeEvent)");
    }
    ...
    default void swipeUp(final SwipeEvent swipeEvent) {
        throw new CoreRuntimeException(NOT_IMPLEMENTED_YET, getClass(), "void swipeUp(final SwipeEvent swipeEvent)");
    }
