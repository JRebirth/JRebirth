...
public interface ScrollAdapter extends EventAdapter {
    ...
    default void anyScroll(final ScrollEvent scrollEvent) {
        throw new CoreRuntimeException(NOT_IMPLEMENTED_YET, getClass(), "void anyScroll(final ScrollEvent scrollEvent)");
    }
    ...
    default void scrollStarted(final ScrollEvent scrollEvent) {
        throw new CoreRuntimeException(NOT_IMPLEMENTED_YET, getClass(), "void scrollStarted(final ScrollEvent scrollEvent)");
    }
    ...
    default void scroll(final ScrollEvent scrollEvent) {
        throw new CoreRuntimeException(NOT_IMPLEMENTED_YET, getClass(), "void scroll(final ScrollEvent scrollEvent)");
    }
    ...
    default void scrollFinished(final ScrollEvent scrollEvent) {
        throw new CoreRuntimeException(NOT_IMPLEMENTED_YET, getClass(), "void scrollFinished(final ScrollEvent scrollEvent)");
    }
