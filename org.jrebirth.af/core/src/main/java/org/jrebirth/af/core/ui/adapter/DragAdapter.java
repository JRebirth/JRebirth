...
public interface DragAdapter extends EventAdapter {
    ...
    default void drag(final DragEvent dragEvent) {
        throw new CoreRuntimeException(NOT_IMPLEMENTED_YET, getClass(), "void drag(final DragEvent dragEvent)");
    }
    ...
    default void dragDone(final DragEvent dragEvent) {
        throw new CoreRuntimeException(NOT_IMPLEMENTED_YET, getClass(), "void dragDone(final DragEvent dragEvent)");
    }
    ...
    default void dragDropped(final DragEvent dragEvent) {
        throw new CoreRuntimeException(NOT_IMPLEMENTED_YET, getClass(), "void dragDropped(final DragEvent dragEvent)");
    }
    ...
    default void dragEntered(final DragEvent dragEvent) {
        throw new CoreRuntimeException(NOT_IMPLEMENTED_YET, getClass(), "void dragEntered(final DragEvent dragEvent)");
    }
    ...
    default void dragEnteredTarget(final DragEvent dragEvent) {
        throw new CoreRuntimeException(NOT_IMPLEMENTED_YET, getClass(), "void dragEnteredTarget(final DragEvent dragEvent)");
    }
    ...
    default void dragExited(final DragEvent dragEvent) {
        throw new CoreRuntimeException(NOT_IMPLEMENTED_YET, getClass(), "void dragExited(final DragEvent dragEvent)");
    }
    ...
    default void dragExitedTarget(final DragEvent dragEvent) {
        throw new CoreRuntimeException(NOT_IMPLEMENTED_YET, getClass(), "void dragExitedTarget(final DragEvent dragEvent)");
    }
    ...
    default void dragOver(final DragEvent dragEvent) {
        throw new CoreRuntimeException(NOT_IMPLEMENTED_YET, getClass(), "void dragOver(final DragEvent dragEvent)");
    }
