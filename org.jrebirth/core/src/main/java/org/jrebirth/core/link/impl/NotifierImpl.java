...
public class NotifierImpl extends AbstractGlobalReady implements Notifier {
     ...
     */
    @Override
    public void sendWave(final Wave wave) {
        try {
     ...
     */
    @Override
    public void listen(final WaveReady linkedObject, final WaveType... waveType) {
     ...
     */
    @Override
    public void unlisten(final WaveReady linkedObject, final WaveType... waveType) {
        for (final WaveType nt : waveType) {
            List<WaveReady> list;
            if (this.notifierMap.containsKey(nt)) {
                list = this.notifierMap.get(nt);
